...
then
	...
	sudo wget https://raw.githubusercontent.com/lucaslucian/Argon40-ArgonOne-Script/master/ar1config.png -O /usr/share/pixmaps/ar1config.png --quiet
	sudo wget https://raw.githubusercontent.com/lucaslucian/Argon40-ArgonOne-Script/master/ar1uninstall.png -O /usr/share/pixmaps/ar1uninstall.png --quiet
	# Create Shortcuts
